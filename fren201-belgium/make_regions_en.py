...
reglabel(4.66,51.10,'FLANDERS','Dutch-speaking',(58,42,0),(94,72,10))
reglabel(4.75,50.12,'WALLONIA','French-speaking',(255,255,255),(255,246,244))

CITIES=[('Antwerp',4.40,51.22,'l'),('Ghent',3.72,51.05,'r'),
...
d.text((bx-46,by), 'Brussels', font=ImageFont.truetype(F,36), fill=INK, anchor='rm')
...
callout((bx+30,by-16), Q(4.35,50.85)[1]-150,
        'BRUSSELS-CAPITAL REGION', 'Bilingual — the federal capital')
gx,gy = Q(6.30,50.42)
callout((gx,gy), gy, 'GERMAN-SPEAKING COMMUNITY', '9 municipalities in the east')

d.text((PADL, FH-34),'Language frontier and community boundary shown approximately.',
       font=f_note, fill=(132,132,142), anchor='ls')
final.save('img/map_belgium_regions_en.png')
print(final.size)
